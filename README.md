...
*This repository is based on the work of [nvim-lua/kickstart.nvim](https://github.com/nvim-lua/kickstart.nvim) as a basis*.
...
```sh
git clone https://codeberg.org/Raiden1/nvim-dotfiles "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
